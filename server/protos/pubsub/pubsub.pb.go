...
func (x *NumSubs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NumSubs) ProtoMessage() {}

func (x *NumSubs) ProtoReflect() protoreflect.Message {
	mi := &file_pubsub_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NumSubs.ProtoReflect.Descriptor instead.
func (*NumSubs) Descriptor() ([]byte, []int) {
	return file_pubsub_proto_rawDescGZIP(), []int{1}
}

func (x *NumSubs) GetValue() int32 {
	if x != nil {
		return x.Value
	}
	return 0
...
var file_pubsub_proto_rawDesc = []byte{
	...
	0x70, 0x75, 0x62, 0x73, 0x75, 0x62, 0x22, 0x2d, 0x0a, 0x03, 0x50, 0x75, 0x62, 0x12, 0x14, 0x0a,
	...
	,
...
var file_pubsub_proto_goTypes = []interface{}{
	(*Pub)(nil),     // 0: pubsub.Pub
	(*NumSubs)(nil), // 1: pubsub.NumSubs
	(*String)(nil),  // 2: pubsub.String
}
var file_pubsub_proto_depIdxs = []int32{
	0, // 0: pubsub.PubSub.Publish:input_type -> pubsub.Pub
	2, // 1: pubsub.PubSub.Subscribe:input_type -> pubsub.String
	1, // 2: pubsub.PubSub.Publish:output_type -> pubsub.NumSubs
	2, // 3: pubsub.PubSub.Subscribe:output_type -> pubsub.String

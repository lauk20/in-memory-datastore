...
type PubSubClient interface {
	// Publish value
	Publish(ctx context.Context, in *Pub, opts ...grpc.CallOption) (*NumSubs, error)
	// Subscribe
...
func (c *pubSubClient) Publish(ctx context.Context, in *Pub, opts ...grpc.CallOption) (*NumSubs, error) {
	out := new(NumSubs)
...
type PubSubServer interface {
	// Publish value
	Publish(context.Context, *Pub) (*NumSubs, error)
	// Subscribe
...
func (UnimplementedPubSubServer) Publish(context.Context, *Pub) (*NumSubs, error) {
...
func _PubSub_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PubSubServer).Publish(ctx, req.(*Pub))
	}
